...
def generate_launch_description():
    ...
    Starts the following nodes:
        - config_publisher: publishes system config once at startup
    ...
    config_publisher_node = Node(
        package='group2_gp1',
        executable='main_config_publisher',
    ...
    safety_monitor_node = Node(
        package='group2_gp1',
        executable='main_safety_monitor',
        name='safety_monitor',
        output='screen',
        emulate_tty=True,
        parameters=[{
